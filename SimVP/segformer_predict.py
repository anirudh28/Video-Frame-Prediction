...
if __name__ == '__main__':
    ...
    train_set_path = '/scratch/ag9563/DL/data/dataset/train/video_' #Change this to your train set path
    val_set_path = '/scratch/ag9563/DL/data/dataset/val/video_' #Change this to your validation path
    ...
    plt.plot(moving_average(training_loss, 20), 'b', label = 'Training Loss')
    plt.legend()
    plt.savefig('Training_Loss.pdf')

    plt.plot(moving_average(validation_loss, 20), 'b', label = 'Validation Loss')
    plt.legend()
